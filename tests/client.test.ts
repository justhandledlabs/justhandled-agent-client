...
test("payment guard pins maintained-data and evidence-heavy products at $0.25", () => {
  for (const utility of ["chicago-demolition-permit-change-packet", "chicago-contract-change-packet", "site-discovery-change-packet", "agent-distribution-readiness-pack", "community-rule-credibility-preflight", "qualified-demand-ledger", "channel-fit-evidence-matrix", "proof-to-channel-evidence-packet", "channel-experiment-postmortem"]) {
